...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-8">
		<br>
		<span class="label label-primary" style="font-size:12px">- Regional Report -</span>
		<h2>{{$basic->name}}</h2>
	</div>
	<div class="col-lg-2">
			...
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-md-12"><strong class="text-success">How would you define where the region is?</strong> <i>{{$basic->defined_region}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">Who has compiled this regional report?</strong> <i>{{$basic->report_owner}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">Does the report align with the national report?</strong> <i>{{$basic->report_align_option==1?"Yes":""}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">How do you want to communicate this local report in your region?</strong> 
									<i>
										<?php if($basic->communication_type==1):?>
											Regional function
										<?php elseif($basic->communication_type==2) :?>
											Website
										<?php elseif($basic->communication_type==3) :?>
											Local churches
										<?php elseif($basic->communication_type==4) :?>
											Other
										<?php endif;?>
									</i>
								</div>
							...
							<div class="row">
								<div class="col-md-12"><strong class="text-success">What are some faith/vision statements or prayers for your region?</strong> <i>{{$basic->vision_statement}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">How does the church use the media/internet for his purposes?</strong> 
									<i>
										<?php if($basic->curch_use_type==1):?>
											Internet
										<?php elseif($basic->curch_use_type==2) :?>
											Facebook
										<?php elseif($basic->curch_use_type==3) :?>
											Mobile Apps
										<?php elseif($basic->curch_use_type==4) :?>
											Twitter
										<?php elseif($basic->curch_use_type==5) :?>
											Print
										<?php elseif($basic->curch_use_type==6) :?>
											TV
										<?php endif;?>
									</i>
								</div>
							...
							<div class="row">
								<div class="col-md-12"><strong class="text-success">What has happened of significance in your region in the church historically?</strong> <i>{{$basic->significance_happen}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">Are there Christian Spiritual ancestors that you want to respect and recognise in this region?</strong> <i>{{$basic->ancestor}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">What is your goal and strategy for achieving this goal in your region?</strong> <i>{{$basic->goal_strategy}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">Population</strong> <i>{{$basic->population}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">Number of christians</strong> <i>{{$basic->christian_number}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">Who are the living Spiritual fathers?</strong> <i>{{$basic->spiritual_father}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">Is there a national report?</strong> <i>{{$basic->national_report_option==1?"Yes":"No"}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">If yes to what is the link to it?</strong> <i>{{$basic->link}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">What is the national vision?</strong> <i>{{$basic->national_vision}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">What are the areas of greatest social need in your region?</strong> <i>{{$basic->social_area}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">Describe the economy both historically and at present.</strong> <i>{{$basic->description_economy}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">What churches do you have in your region and describe them?</strong> <i>{{$basic->churches}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">Quantitatively state what the church do in your region to help?</strong> <i>{{$basic->quantitatively_state}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">How many people get saved each year?</strong> <i>{{$basic->yearly_people_count}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">Describe crime in the area?</strong> <i>{{$basic->description_crime}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">What is the suicide rate?</strong> <i>{{$basic->suicide_rate}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">Do schools have a Christian witness?</strong> <i>{{$basic->has_christian_witness}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">Does business help the community?</strong> <i>{{$basic->help_community}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">Is there significant occult or anti Christian activity?</strong> <i>{{$basic->occult_activity}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">Where and when are the prayer meetings?</strong> <i>{{$basic->prayer_meeting}}</i></div>
							</div><br>
							<div class="row">
								<div class="col-md-12"><strong class="text-success">What evangelism programs are there in your region?</strong> <i>{{$basic->evangelism_program}}</i></div>
							</div><br>
						</div>
					</div>
					<br>
...
<script>
	$(document).ready(function() {
		...
		$(".eventlist a").click(function(ev) {
			...
			$("body").mask("");
			$.get("/ajax/project/regionalreport/events/get/"+$id, {}, function(response) {
				$("body").unmask();
				if(response.success) {
					info = response.info;
		...
		$("button[name='modal-join']").click(function() {
			...
			$.post("/ajax/project/regionalreport/events/join/"+$id, {
				...
				if(response.success) {
					...
					$("button[name='withdraw_event']").click(function() {
						...
						$.post("/ajax/project/regionalreport/events/withdraw/"+$id, {}, function(response) {
							if(response.success) {
		...
		$("button[name='invite']").click(function() {
			...
			$.post("/ajax/project/regionalreport/{{$project_id}}/"+$id+"/invite", {}, function(response) {
				if(response.success) {
