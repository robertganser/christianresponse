					...
					<ul class="nav" id="side-menu">
						...
						<li <?php echo $active == "manages" ? "class='active'" : ""?>>
							...
							<ul class="nav nav-second-level">
								...
								<!--
								<li>
									<a href="/manages/user-permission">User Permission</a>
								</li>-->
								<li>
									<a href="/manages/region">Region</a>
								</li>
								...
								<li>
									<a href="/manages/video-setting">Video Setting</a>
								</li>
								<li>
									<a href="/manages/posts">Posts</a>
								</li>
								<li>
									<a href="/manages/aboutus">About Us</a>
								</li>
								<li>
									<a href="/manages/contactus">Contact Us</a>
								</li>
								<li>
									<a href="/manages/teaching-course">Teaching Courses</a>
								</li>
							</ul>
						</li>
						<li <?php echo $active == "financial" ? "class='active'" : ""?>>
							<a href="/financial"><i class="fa fa-newspaper-o"></i> <span class="nav-label">Financial</span></a>
						</li>
						<li <?php echo $active == "contacts" ? "class='active'" : ""?>>
							<a href="/contacts"><i class="fa fa-user"></i> <span class="nav-label">Contact List</span></a>
						</li>
						<li <?php echo $active == "settings" ? "class='active'" : ""?>>
							...
							<ul class="nav nav-second-level">
								...
								<!--<li>
									<a href="/settings/paypal-address">Paypal Address</a>
								</li>-->
							</ul>
						</li>
					</ul>
