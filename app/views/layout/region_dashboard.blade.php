			...
			<nav class="navbar-default navbar-static-side" role="navigation">
				<div class="sidebar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li <?php echo $active == "search" ? "class='active'" : ""?>>
							<a href="#"><i class="fa fa-search"></i> <span class="nav-label">Search</span> <span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<li>
									<a href="/search/project">Project</a>
								</li>
								<!--<li>
									<a href="/search/localreport">Local Report</a>
								</li>-->
								<li>
									<a href="/search/nationalreport">National Report</a>
								</li>
								<li>
									<a href="/search/regionalreport">Regional Report</a>
								</li>
								<li>
									<a href="/search/facilitator">Facilitator</a>
								</li>
								<li>
									<a href="/search/testimony">Testimony</a>
								</li>
								<li>
									<a href="/search/mission">Mission Statement</a>
								</li>
								<li>
									<a href="/search/gifts">Gifts</a>
								</li>
								<li>
									<a href="/search/goals">Goals</a>
								</li>
							</ul>
						</li>
						<li <?php echo $active == "projects" ? "class='active'" : ""?>>
							<a href="#"><i class="fa fa-database"></i> <span class="nav-label">My Projects</span> <span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<li >
									<a href="/projects/prayer">Prayer</a>
								</li>
								<li>
						...
						<li <?php echo $active == "region" ? "class='active'" : ""?>>
							<a href="/region"><i class="fa fa-glob"></i> <span class="nav-label">My State Region</span></a>
						</li>
						<li <?php echo $active == "manages" ? "class='active'" : ""?>>
							...
							<ul class="nav nav-second-level">
								<li>
									<a href="/manages/region-page">Region</a>
								</li>
