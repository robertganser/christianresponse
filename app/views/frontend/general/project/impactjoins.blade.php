...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		<h2><?php echo $event->title?> - Joined Users</h2>
		<ol class="breadcrumb">
			<li>
				<a>Projects</a>
			</li>
			...
			<li>
				<a href="/{{$active=='manages'?'manages/':''}}projects/impact/{{$project_id}}/events"><?php echo $event->title?></a>
			</li>
			<li class="active">
				<strong>Joined user</strong>
			</li>
		</ol>
		<br>
