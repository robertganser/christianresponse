		...
		<div class="col-lg-2">
			<div class="contact-box" style="padding:10px 0px">
				<a href="/search/facilitator/single/view/<?php echo $one->id?>">
					...
					<!--<div class="row">
						<div class="col-sm-8">
							<h3 class="hilight_name text-success"><strong><?php echo $one->first_name?> <?php echo $one->last_name?></strong></h3>
							<p>
...
<script>
	$(document).ready(function() {
		...
		if("<?php echo $search_key?>" != "") {
			$('.hilight_name').removeHighlight();
			$('.hilight_name').highlight_search("<?php echo $search_key?>");
		}
		*/
	}); 
</script>
