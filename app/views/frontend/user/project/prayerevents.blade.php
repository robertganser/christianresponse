...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		...
		<ol class="breadcrumb">
			...
			<li>
				<a href="/projects/prayer"><?php echo $project_title?></a>
			</li>
			<li class="active">
							...
							<tbody>
								<?php $i = 1; foreach($events as $one) :?>
									<tr>
										...
										<td nowrap=""><a href="/projects/prayer/{{$project_id}}/event/{{$one->id}}/joins"><span class="label label-info">{{$one->joined_count}}</span></a></td>
										<td nowrap="" align="right" width="70px">
											<a href="/projects/prayer/{{$project_id}}/events/edit/{{$one->id}}">
...
<script>
	$(document).ready(function() {
		...
		$("button[name='agree']").click(function() {
			location.href = "/projects/prayer/{{$project_id}}/events/edit";
		});
