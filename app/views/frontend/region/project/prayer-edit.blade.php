...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		<h2>Edit Prayer Project Form</h2>
		<ol class="breadcrumb">
			<li>
				<a href="/{{$active=='manages'?'manages/':''}}projects/prayer">Projects</a>
			</li>
			<li>
				<a href="/{{$active=='manages'?'manages/':''}}projects/prayer">Prayer</a>
			</li>
			<li class="active">
				<strong>Edit</strong>
			</li>
		...
		<div class="col-lg-12">
			<div class="row">
				...
				<div class="col-lg-10">
					...
					<p>
						Public prayer meetings can have different focus. It may involve a time of worship. Public connection with God builds peoples faith and brings encouragement. It is hoped that in your region there is always a prayer meeting you can attend morning afternoon and night.
					</p>
				</div>
				<div class="col-lg-1"></div>
			</div>
...
<script>
	$(document).ready(function() {
		$("button[name='cancel']").click(function() {
			location.href = "/{{$active=='manages'?'manages/':''}}projects/prayer";
		});
