			...
			<div class="ibox-content">
				...
				<div class="search-result">
					<div class="row">
						...
						<div class="col-lg-11">
							<h3><a href="/search/gifts/single/view/<?php echo $one->id?>"><strong><?php echo $one->first_name?> <?php echo $one->last_name?></strong></a></h3>
							<a href="#" class="search-link"><?php echo $one->email?></a>
							<p>
								<div class="testimony_row"><?php echo $one->skill_gifts?></div>
							</p>
						</div>
					</div>
				</div>
