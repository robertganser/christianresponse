...
<form name="frmDonation" method="post">
	<div style="min-height: 600px">
		...
		<div align="right">
			...
			<br>
			<a href="javascript:void(0)" name="process"><img src="/images/paypal-checkout-orange.png" width="200px" style="border:0px"></a>
		</div>
	</div>
</form>
<script>
	...
	function calc() {
		...
		$row1_unit_price = round($amount * .925, 2);
		$row1_total_price = $row1_unit_price;

		$row2_unit_price = round($amount * .075, 2);
		...
		$("#subtotal_amount").html(round($row1_unit_price + $row2_total_price, 2));
