! function(e) {
	e.fn.least = function(l) {
		...
		return this.each(function() {
			function l(l, t, a) {
				var i = e('<figure class="close"></figure>'), s = e('<img src="' + t + '"/>'), r = e("li a");
				s.load(function() {
			...
			if (e(this).find("li a").click(function(t) {
					var a = e(this), i = a.attr("href"), s = e(".least-preview"), r = s.children("img"), n = a.attr("data-caption") || "";
					return r.length && i === r.attr("src") ? (s.slideToggle("slow"),
					void  a.toggleClass("active")) : (r.length ? (a.addClass("active"), e(".least-gallery li a.active").removeClass("active"), s.slideUp("slow", function() {
						l(s, i, n)
					})) : l(s, i, n),
					void  a.addClass("load active"))
				}), t.random && e(".least-gallery").each(function() {
					var l = e(this), t = l.children("li");
					t.sort(function() {
						var e = parseInt(8 * Math.random(), null), l = e % 4, t = e > 2 ? 1 : -1;
						return l * t
					}).appendTo(l)
				...
				for (var a = e("#least img"), i = e("#least a"), s = 0; s < a.length && i.length; s++) {
					var r = a[s].src, n = i[s].href, o = r.lastIndexOf("."), c = n.lastIndexOf(".");
